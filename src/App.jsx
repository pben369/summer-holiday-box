  ...
  useEffect(() => {
    ...
    const loadChannels = async () => {
      ...
      const youtubePlaylists = [
        ...
        {
          id: 'yt-avatar',
          name: 'Avatar Airbender (Hindi)',
          logo: 'avatar-logo.png',
          category: 'YouTube Series',
          url: 'https://www.youtube.com/embed/hzl_9eRNeYY?autoplay=1&controls=1&modestbranding=1&rel=0&fs=0',
        },
        {
          id: 'yt-avatar-book1',
          name: 'Avatar Airbender Book1 (English)',
          logo: 'avatar-logo.png',
          category: 'YouTube Series',
          url: 'https://www.youtube.com/embed/lc0gis09VZs?autoplay=1&controls=1&modestbranding=1&rel=0&fs=0',
        },
        {
          id: 'yt-avatar-book2',
          name: 'Avatar Airbender Book2 (English)',
          logo: 'avatar-logo.png',
          category: 'YouTube Series',
          url: 'https://www.youtube.com/embed/nID6AAw4zQ4?autoplay=1&controls=1&modestbranding=1&rel=0&fs=0',
        },
        {
          id: 'yt-ducktales',
